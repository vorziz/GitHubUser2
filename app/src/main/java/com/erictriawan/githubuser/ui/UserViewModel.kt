...
import com.erictriawan.githubuser.extension.fromIoToMain
import com.erictriawan.githubuser.extension.toMain
...
class UserViewModel : ViewModel(), KoinComponent {
    ...
    private val searchService: GitHubService by inject()
    ...
    private fun loadUserFromObservable(observable: Observable<UserRespons<User>>) {
